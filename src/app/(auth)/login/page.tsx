...
export default function LoginPage() {
    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50 relative overflow-hidden px-4">
            ...
            <div className="absolute top-0 right-0 -mr-20 -mt-20 w-96 h-96 bg-green-200 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob" />
            <div className="absolute bottom-0 left-0 -ml-20 -mb-20 w-72 h-72 bg-emerald-200 rounded-full mix-blend-multiply filter blur-3xl opacity-50 animate-blob animation-delay-2000" />
            ...
            <main className="w-full max-w-md z-10 animate-fade-up">
                ...
                <div className="flex flex-col items-center mb-8">
                    ...
                    <h1 className="text-3xl font-bold text-slate-900 tracking-tight text-center">{t("auth.welcomeBack")}</h1>
                    <p className="text-slate-500 mt-2 text-center text-sm">{t("auth.loginDesc")}</p>
                </div>
